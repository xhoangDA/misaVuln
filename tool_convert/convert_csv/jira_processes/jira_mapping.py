...
# def assignee_name_to_key(assignee_name, file_json_path = "D:/my tools/convert_csv/jira_processes/jira-users.json"):
#     """
#     Tìm display name tương ứng với project key trong file JSON
...
if __name__ == '__main__':
    # # Đầu vào mảng JSON ví dụ
    # with open('D:/my tools/convert_csv/final_output.json', 'r', encoding='utf-8') as f:
    #     input_json = json.load(f)
    
    # mapping_file = "D:/my tools/convert_csv/jira_processes/hostname_mapping.txt"
    # processed_json = process_target_details(input_json, mapping_file)
    
    # # print(json.dumps(processed_json, indent=2))
    # with open('json_output.json', mode='w', encoding='utf-8') as json_file:
    #     json.dump(processed_json, json_file, indent=4, ensure_ascii=False)
    ...
    try:
        ...
        print(f"Project id: {project_name}")  # Kết quả: "5FOOD"
